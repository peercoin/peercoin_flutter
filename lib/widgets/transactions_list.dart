        ...
        GestureDetector(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (_, i) {
                ...
                return Container(
                  ...
                  child: Card(
                    child: ListTile(
                      ...
                      leading: Column(
                          ...
                          children: [
                            AnimatedContainer(
                                ...
                                child: _filteredTx[i-1].broadCasted == false
                                    ? Text('?',
                                    textScaleFactor: 0.9,
                                    style: TextStyle(
                            ...
                            Text(
                              DateFormat('d. MMM').format(
                                  _filteredTx[i-1].timestamp != null
                                      ...
                                      : DateTime.now()),
                              style: TextStyle(
                                fontWeight: _filteredTx[i-1].timestamp != null
                                    ? FontWeight.w500
                                    : FontWeight.w300,
                              ),
                              textScaleFactor: 0.8,
                      ...
                      subtitle: Center(
                        child: Text(
                          resolveAddressDisplayName(_filteredTx[i-1].address),
                          overflow: TextOverflow.ellipsis,
                          textScaleFactor: 1,
                        ),
                      ),
                        ...
                        children: [
                          Text(
                            (_filteredTx[i-1].direction == 'in' ? '+' : '-') +
                                (_filteredTx[i-1].value / 1000000).toString(),
                            style: TextStyle(
                                fontWeight: _filteredTx[i-1].timestamp != null
                                    ? FontWeight.bold
                                    : FontWeight.w300,
              ...
              else if (i==0 && _filteredTx.isNotEmpty){
                return Column(
                  children: [
                    SizedBox(height:150),
                    Wrap(
