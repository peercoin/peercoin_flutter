...
final $typed_data.Uint8List blockHeightRequestDescriptor =
    $convert.base64Decode('ChJCbG9ja0hlaWdodFJlcXVlc3Q=');
...
final $typed_data.Uint8List blockHeightReplyDescriptor = $convert
    .base64Decode('ChBCbG9ja0hlaWdodFJlcGx5EhYKBmhlaWdodBgBIAEoDVIGaGVpZ2h0');
...
final $typed_data.Uint8List broadCastTransactionReplyDescriptor =
    $convert.base64Decode(
        'ChlCcm9hZENhc3RUcmFuc2FjdGlvblJlcGx5EhIKBHR4aWQYASABKAlSBHR4aWQSHwoIcnBjRXJyb3IYAiABKAlIAFIIcnBjRXJyb3KIAQFCCwoJX3JwY0Vycm9y');
...
final $typed_data.Uint8List addressRequestDescriptor = $convert
    .base64Decode('Cg5BZGRyZXNzUmVxdWVzdBIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNz');
...
final $typed_data.Uint8List addressListRequestDescriptor = $convert.base64Decode(
    'ChJBZGRyZXNzTGlzdFJlcXVlc3QSGAoHYWRkcmVzcxgBIAEoCVIHYWRkcmVzcxIcCglhc2NlbmRpbmcYAiABKAhSCWFzY2VuZGluZw==');
...
final $typed_data.Uint8List addressBalanceReplyDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List addressUtxoListReplyDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List addressHistoryReplyDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List addressNumberOfUtxosReplyDescriptor = $convert
    .base64Decode('ChlBZGRyZXNzTnVtYmVyT2ZVdHhvc1JlcGx5EgwKAW4YASABKA1SAW4=');
...
final $typed_data.Uint8List addressIsKnownReplyDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List txRequestDescriptor =
    $convert.base64Decode('CglUeFJlcXVlc3QSEgoEdHhpZBgBIAEoCVIEdHhpZA==');
...
final $typed_data.Uint8List txReplyDescriptor =
    $convert.base64Decode('CgdUeFJlcGx5Eg4KAnR4GAEgASgJUgJ0eA==');
...
final $typed_data.Uint8List testStreamRequestDescriptor =
    $convert.base64Decode('ChFUZXN0U3RyZWFtUmVxdWVzdA==');
...
final $typed_data.Uint8List testStreamReplyDescriptor = $convert
    .base64Decode('Cg9UZXN0U3RyZWFtUmVwbHkSEgoEbmFtZRgBIAEoCVIEbmFtZQ==');
